                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="row">
                            ...
                            <div class="col-md-1" style="margin-top: 10px;">
                                <a class="btn btn-success " href="{{route('admin.article.index')}}"><span class="glyphicon glyphicon-repeat"></span> Quay lại danh sách</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <form role="form" action="{{route('admin.article.update', ['id' => $article->id ])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Tóm tắt</label>
                                <textarea id="editor1" name="summary" class="form-control" rows="10" >{{ $article->summary }}</textarea>
                            ...
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea id="editor2" name="description" class="form-control" rows="10" >{{ $article->description }}</textarea>
